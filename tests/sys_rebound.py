...
def calc_diff():
    ...
    rra, rde, rvz = nbody.calc_orbit(epochs, sma,ecc,inc,aop,pan,tau,plx,mtot,tau_ref_epoch, m_pl)
    ora = ra
    odec = dec
...
def plot_orbit():
    ...
    rra, rdec, rvz = nbody.calc_orbit(epochs, sma,ecc,inc,aop,pan,tau,plx,mtot,tau_ref_epoch, m_pl)
